      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 video-box">
            <img src="${pageContext.request.contextPath}/assets/img/why-us.jpg" class="img-fluid" alt="">
    ...
    <section class="features">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-md-5">
            <img src="${pageContext.request.contextPath}/assets/img/features-1.svg" class="img-fluid" alt="">
          </div>
